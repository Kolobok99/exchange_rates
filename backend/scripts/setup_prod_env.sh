...
#
echo SQL_ENGINE=$PROD_SQL_ENGINE >> ./backend/.env_files/.env.prod/.env.prod.settings
echo SQL_NAME=$PROD_SQL_NAME >> ./backend/.env_files/.env.prod/.env.prod.settings
echo SQL_USER=$PROD_SQL_USER >> ./backend/.env_files/.env.prod/.env.prod.settings
echo SQL_PASSWORD=$PROD_SQL_PASSWORD >> ./backend/.env_files/.env.prod/.env.prod.settings
...
#
echo MYSQL_DATABASE=$PROD_SQL_HOST >> ./backend/.env_files/.env.prod/.env.prod.db
